    ...
    <div className='case-study'>
      ...
      <div className='col col--gap'>
          <div className="img-wrapper col-large">
            <img className='img' src={final1} alt="" />
          </div>
      ...
      <section className="section">
        <div className='col col--gap'>
          ...
          <div className="img-wrapper col-large">
            <img className='img' src={final2} alt="" />
          </div>
        </div>
      </section>
      <section className="section">
        <div className='col col--gap'>
          <div className="img-wrapper col-large">
            <img className='img' src={final3} alt="" />
          </div>
          <div className='col-small'>
      ...
      <section className="section">
        ...
        <div className="img-wrapper section__img">
            <img className='img' src={process} alt="" />
          </div>
      </section>
      <section className="section">
      ...
      <section className="section">
        ...
        <div className="col img-wrapper section__img">
          <div>
              <img className='img' src={qr1} alt="" />
          </div>
          <div>
              <img className='img' src={qr2} alt="" />
          </div>
        </div>
      </section>
      <section className="section">
      ...
      <section className="section">
        ...
        <div className="img-wrapper section__img">
            <img className='img' src={persona} alt="" />
          </div>
      </section>
      <section className="section">
        ...
        <div className="img-wrapper section__img">
            <img className='img' src={journey} alt="" />
          </div>
      </section>
      <section className="section">
      ...
      <section className="section">
        <h5 className='section__heading'>Solution</h5>
        <h3 className='section__title'>
        What if we made personal goals more like schoolwork?
        </h3>
        <p className='section__text'>
      ...
      <section className="section">
        ...
        <p className='section__text'>
        This test was conducted using a Figma prototype. I designed wireframes with minimal styling to help students focus on the concept and flow of the app.        </p>
        <div className="img-wrapper section__img">
          <img className='img' src={utSteps} alt="" />
        </div>
      </section>
      <section className="section">
        ...
        <br /> <br />
        As there were still some minor confusion and concerns, I made some changes based on feedback:     </p>
      </section>
      <section className="section">
      <div className='col col--gap'>
          <div>
      ...
      <section className="section">
        ...
        <p className='section__text'>
        I had a ton of fun designing Checkmate! If I had more time, I would love to experiment with adding the following features:</p> <br />
        <ul>
      ...
      <section className="section">
        ...
        <p>I was worried about creating a habit tracker at first as it is one of the most common types of app out there. However, through competitive analysis and user research, I was able to identify a key missing factor of accountability in these apps to create a more unique and effective solution to habit building!</p> <br />
        <h6>Personal experience is a great way to empathize with your target audience</h6>
        <p>I first got the idea for this app because it was a tool I really wish I had. When interviewing other college students, I could definitely empathize with their problems when it came to balancing your academic and personal goals, and I think this helped me connect with my interviewees and come up with more meaningful insights.</p> <br />
        <h6>Users approach the same app differently</h6>
        <p>When it comes to user experience design, it’s easy to fall in the trap of designing for an “ideal user”--one that thoroughly read every description and outlines you have. However, during user testing, I learned that users approach the same apps differently. Some fly through the app by scanning the screens while others spend more time thoroughly reading through each description. This made me realize how important it is to user test and maintain a strong visual hierarchy that can guide the users.</p>
      </section>
      </div>
    </div>
  )
