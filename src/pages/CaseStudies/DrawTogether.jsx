...
import low2 from '../../images/draw-together/low-settings.png'
import low3 from '../../images/draw-together/low-mode.png'
  ...
  return (
    <div className='case-study'>
      ...
      <section className="section">
        ...
        <p className='section__text'>
        I analyzed popular drawing games and their pros and cons for inspiration.  </p>
        <div className='col section__img'>
          <div className='col col--dt'>
          <img className='img img--dt' src={ca1} alt="" />
          <h6>Skribbl.io</h6>
          <p>Online draw and guess game</p>
          </div>
          <div className='col col--dt'>
          <img className='img img--dt' src={ca2} alt="" />
          <h6>Painting Swap Challenge</h6>
          <p>Paint and swap with partner</p>
          </div>
          <div className='col col--dt'>
          <img className='img img--dt' src={ca3} alt="" />
      ...
      <section className="section">
        ...
        <p className='section__text'>
          Through competitive analysis, we knew our idea had potential. Collaborative drawing seemed to be effective in making art more fun!

          We used this knowledge to guide our ideation and came up with three game ideas: Draw Together, Canvas Swap, and Top Bottom. 

          Draw Together: draw with other players in real-time
          Canvas Swap: digitized version of the painting swap challenge
          Top Bottom: players draw on separate parts of the canvas
      ...
      <section className="section">
        ...
        <p className='section__text'>
        As we are a small team, we needed to define our MVP to save time and validate our ideas.
      ...
      <section className="section">
        ...
        <div className="img-wrapper section__img">
            <img className='img' src={flow} alt="" />
        </div>
      </section>
      <section className="section">
        <h5 className='section__name'>Wireframes</h5>
        <h3 className='section__title'>Low fidelity wireframes</h3>
        <p className='section__text'>We started off with a low fidelity wireframe to define our vision as a team. I worked with one other designer on the wireframes. <br /> <br />
        ...
        <div className="img-wrapper">
            <img className='img' src={low1} alt="" />
            <img className='img' src={low2} alt="" />
        </div>
        <div className="img-wrapper">
          <img className='img' src={low3} alt="" />
            <img className='img' src={low4} alt="" />
        </div>
        </div>
      </section>
      <section className="section">
        ...
        <p className='section__text'>As this is a drawing game, we wanted to make the UI playful and fun. To achieve this, we used a handwritten font for headings and a more readable monoscript font for smaller texts. We also used hand-drawn illustrations throughout the website with a pastel color palette.     </p>
        <div className="img-wrapper section__img">
            <img className='img' src={style} alt="" />
          </div>
      </section>
      <section className="section">
        <h5 className='section__name'>Mockups</h5>
        <h3 className='section__title'>High-Fidelity Mockup</h3>
        <p className='section__text'>
        We applied our style guide to create the first mockup of our game. We also addressed problems identified with our low-fidelity wireframes in these mockups.      
         ...
         <div className="col">
        <div className="img-wrapper">
            <img className='img' src={high1} alt="" />
            <img className='img' src={high2} alt="" />
        </div>
        <div className="img-wrapper">
          <img className='img' src={high3} alt="" />
            <img className='img' src={high4} alt="" />
        </div>
        </div>
      </section>
      <section className="section">
      ...
      <section className="section">
        ...
        <div className="col section__img">
              <div className="img-wrapper">
                <img className='img' src={ut1} alt="" />
              </div>
              <div className="img-wrapper">  
                <img className='img' src={ut2} alt="" />
              </div>
          </div>
        <div className="img-wrapper section__img">
            <img className='img' src={utDrawings} alt="" />
        </div>
      </section>
      <section className="section">
        <div>
            <h4 className = 'section__heading--small'>1. Tutorial Popup</h4>
            <p>Originally, the games started automatically after a short countdown. Many users expressed confusion and frustration because of this. To address this, we added a popup with a quick tutorial and information about the other player. This will provide users with a better understanding of the game mechanics and confirm they are matched with the intended player.</p>
            <div className="col section__img">
              <div className="img-wrapper">
                <img className='img' src={old1} alt="" />
              </div>
              <div className="img-wrapper">  
                <img className='img' src={new1} alt="" />
              </div>
          </div>
        </div>
      ...
      <section className="section">
      <div>
          <h4 className = 'section__heading--small'>2. New Canvas Tools, Features</h4>
        ...
        <div className="col section__img">
              ...
              <div className="img-wrapper">  
                <img className='img' src={new2} alt="" />
              </div>
          </div>
          <div className="section__img">
          <img className='img' src={features} alt="" />
        </div>
      </section>
      <section className="section">
      <div>
          <h4 className = 'section__heading--small'>3. Better Swapping Transition</h4>
          ...
          <div className="img-wrapper section__img">
            <img className='img' src={new3} alt="" />
        </div>
        </div>
      </section>
      <section className="section">
