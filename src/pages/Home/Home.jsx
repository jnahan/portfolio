...
function Home() {
  ...
  return (
    <div className='home'>
      ...
      <div className="jenna">
        <div className="track">
            <p id="infinite-text">✽ jenna han ✽ jenna han ✽ jenna han ✽ jenna han ✽ jenna han ✽ jenna han ✽ jenna han ✽ jenna han ✽ jenna han ✽ jenna han ✽ jenna han ✽ jenna han ✽ jenna han ✽ jenna han ✽ jenna han ✽ jenna han ✽ jenna han ✽ jenna han ✽ jenna han ✽ jenna han ✽ jenna han ✽ jenna han ✽ 
            </p>
          </div>
      </div>
