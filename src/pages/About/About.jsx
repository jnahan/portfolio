...
function About() {
  ...
  return (
    <div className='about section'>
        <section>
            <h2 className='about__heading--1'>Hi, I'm Jenna <span className='wave'>👋</span></h2>
            <p className='about__text'>I’m a product designer based in New York City and I love creating things with design and code! I’m currently pursuing a bachelor’s degree in Interactive Media Arts and Computer Science at New York University. I aim to create intuitive designs that put the users’ needs first. <br /> <br />
