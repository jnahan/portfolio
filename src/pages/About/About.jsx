        ...
        <div className="about section">
            <section>
                ...
                <p className="about__text">
                    ...
                    <a className="content-link" target="_blank" rel="noreferrer" href="mailto: jh7765@nyu.edu">Email</a> <br />
                    <a className="content-link" target="_blank" rel="noreferrer" href="https://drive.google.com/file/d/1G5OY5Cf2xfemzcIwh7Q0Fgwz_LGnk693/view?usp=sharing">Resume</a>
                </p>
